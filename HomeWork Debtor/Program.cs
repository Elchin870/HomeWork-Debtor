...
class Program1
{
    ...
    public static void Main()
    {
        ...
        //var result = debtors.Where(d => d.FullName.Length > 16 && d.Phone.Count(c=> c=='7')>=2);
        //foreach (var item in result)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //var result = debtors.Where(d => d.BirthDay.Month == 12 || d.BirthDay.Month == 1 || d.BirthDay.Month == 2);
        //foreach (var item in result)
        //{
        //    Console.WriteLine(item);
        //}
        ...
        //var result = debtors.Where(d => d.Phone.Count(c => c == '8') == 0);
        //foreach (var item in result)
        //{
        ...
        //var result = debtors.Where(d => d.Debt.ToString().Distinct().Count()+2 == d.Debt.ToString().Length);
        //var sortedFullname=result.OrderBy(d=>d.FullName);
        //foreach (var item in sortedFullname)
        //{
        ...
        //var yearGroups = debtors.GroupBy(d => d.BirthDay.Year).Select(g => new { Year = g.Key, Count = g.Count() }) .OrderByDescending(g => g.Count).ToList();

        //var maxYear = yearGroups.First().Year;
        ...
        //foreach (var item in topDebtors)
        //{
        ...
        //var result = debtors.Where(d => d.Debt.ToString().Distinct().Count() == d.Debt.ToString().Length);
        //foreach (var item in result)
        //{
